...
// The project was completed using help from the Code Reviewer, BC Ko from Github and other google searches
...
vector< vector<float> > normalize(vector< vector <float> > grid) {
	...
	return newGrid;  //Returning the newGrid with normalized probability
}
...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
	...
	return normalize(newGrid);  //Returning the newGrid with normalized probability
